  ...
  register() {
    if (this.registerForm.valid) {
      ...
      this.authService.register(newUser).subscribe(successResponse => {
        ...
        this.toastrService.success("Login Successfull", "Logged In");
      }, errorResponse => {
        this.errorService.showBackendError(errorResponse, "Registration Failed");
      })
    } else {
      this.toastrService.error("Incomplete Registration", "Please Try again!");
    }
  }
