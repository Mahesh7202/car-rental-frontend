...
export class PaymentComponent implements OnInit {
  ...
  confirmCreditCard() {
    let usingCard: CreditCard;
    console.log('sssssssssssssssss')
    console.log(this.paymentForm.value);
    if (this.paySavedCard) {
      usingCard = this.savedCreditCards[this.selectedSavedCreditCard];
    ...
    if (this.paymentForm.valid) {
      ...
      this.toastrService.error("Please Fill the Card Information Correctly", "Card Inforamtion Missing")
    }
    ...
    const creditCard: CreditCard = {
     ...
     this.creditCardService.registerCreditCard(creditCard).subscribe(() => {
      this.toastrService.success(creditCard.cardNumber, "Credit card Added Successfully");
    }, errorResponse => {
      console.log(errorResponse, "Failed to add Brand");
    });
  }
  ...
  deleteCreditCard(creditCard: CreditCard) {
    this.getCustomerId().then((customerId) => {
      ...
      this.creditCardService.deleteCreditCard(customerCreditCardModel).subscribe(() => {
        ...
        this.toastrService.success("Your Registered Credit Card Deleterd Successsfully", "Credit Card Deleted");
      }, () => {
        this.toastrService.error("There Was a Problem while Deleting Your Credit Card", "Failed to Delete Credit Card");
      })
    })
  }
